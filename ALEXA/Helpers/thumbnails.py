...
from ALEXA import BOT_ID, LOGGER, app
...
async def gen_thumb(videoid, user_id):
    ...
    try:
        ...
        bg = Image.open(f"ALEXA/Helpers/utils/circle.png")
        ...
        font = ImageFont.truetype("ALEXA/Helpers/utils/font2.ttf", 45)
        ImageFont.truetype("ALEXA/Helpers/utils/font2.ttf", 70)
        arial = ImageFont.truetype("ALEXA/Helpers/utils/font2.ttf", 30)
        ImageFont.truetype("ALEXA/Helpers/utils/font.ttf", 30)
